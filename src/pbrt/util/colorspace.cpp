...
const RGBColorSpace *RGBColorSpace::ACES2065_1;
    ...
    /*
    stdillum-D65 : D65 roughly corresponds to the color temperature of the sky on a clear
   day around noon. First and foremost, D65 is defined by a particular spectral power
   distribution that is generated by a D series daylight simulator.
*/
