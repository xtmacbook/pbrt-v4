...
namespace pbrt {
      ...
      /*
the RGBColorSpace constructor takes its full spectral distribution, which is useful for
forthcoming code that converts from color to spectral distributions.

illuminant: Storing the illuminant spectrum allows users of the renderer to specify
emission from light sources using RGB color; the provided illuminant then gives the
spectral distribution for RGB white, (1,1,1)

rgbToSpectrumTable: stores information related to converting RGB values in the color space
to full spectral distributions
*/
class RGBColorSpace {
  public:
