...
class PixelSensor {
  ...
  private:
        /*
      b1,b2,b3: spectral matching functions

      c_{i} = \int r(\lambda) L_{\lambda} b_{i}d\lambda

     r(\lambda):is the spectral reflectance function

     L: is the illuminant¡¯s spectral distribution

     b:is a spectral matching function
